package br.com.zup.edu.validations.handler.config
...
@Singleton
class ExceptionHandlerGrpcServerInterceptor(@Inject private val resolver: ExceptionHandlerResolver) : MethodInterceptor<BindableService, Any?> {
